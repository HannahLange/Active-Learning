...
for i in range(2**qubit_no):
    state_vector.append(1/np.sqrt(2**qubit_no))
...
tomography_state = state.IBMstate(IBMtoken, {"qc_type": state_type, "qubit_no": qubit_no, "init_state": state_vector}, "classical")
...
fidelity_threshold = 0.95 # threshold value of the fidelity to decide when to stop the learning for the IBM states
...
n_samples = 2 # number of measurements in the reference basis
query_samples = 2 # number of measurements for each query
